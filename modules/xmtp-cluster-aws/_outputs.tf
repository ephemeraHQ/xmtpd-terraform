...
output "public_subnet_cidrs" {
  value       = module.k8s.public_subnet_cidrs
  description = "Public subnet CIDRs"
}

output "private_subnet_cidrs" {
  value       = module.k8s.private_subnet_cidrs
  description = "Private subnet CIDRs"
}

output "vpc_cidr" {
  value       = module.k8s.vpc_cidr
  description = "VPC ID"
}
...
output "eks_cluster_arn" {
  ...
  value       = module.k8s.eks_cluster_arn
}
...
output "eks_cluster_version" {
  ...
  value       = module.k8s.eks_cluster_version
}

output "eks_cluster_identity_oidc_issuer" {
  description = "The OIDC Identity issuer for the cluster"
  value       = module.k8s.eks_cluster_identity_oidc_issuer
}
...
output "eks_cluster_managed_security_group_id" {
  ...
  value       = module.k8s.eks_cluster_managed_security_group_id
}
